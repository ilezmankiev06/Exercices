...
describe("Let the tests on arrays begin !", () => {
  ...
  test("Indiana Jones 4 doesn't have to be present in mockArray", () => {
  ...
  test("Check if array contains anly String element", () => {
  mockArray = ["Lord of the rings : the return of the king", "Into the wild", "Alien the 8th passenger", "Tombeau des lucioles", "fight club"];
  ...
  test("Should have Lord of the rings inside mockArray", () => {
    expect.assertions(1);
  mockArray = ["Lord of the rings : the return of the king", "Into the wild", "Alien the 8th passenger", "Tombeau des lucioles", "fight club"];
  if (mockArray.includes("Lord of the rings")) {
